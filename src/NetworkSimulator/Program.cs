...
{
  /// <summary>
  /// IoP Network Simulator simulates network of IoP servers on a single machine.
  /// 
  /// 
  /// Usage: NetworkSimulator ScenarioFile
  ///   * ScenarioFile contains a description of the simulation to execute.
  ///   
  /// </summary>
  public class Program
  {
    private static Logger log = new Logger("NetworkSimulator.Program");
    ...
    public static void Main(string[] args)
    {
      ...
      if (args.Length != 1)
      {
        log.Error("Usage: NetworkSimulator <ScenarioFile>");
        log.Trace("(-)");
        return;
      }
